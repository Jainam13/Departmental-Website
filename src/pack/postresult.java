...
public class postresult extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("NETID IN POSTRESULT:"+netid);
		ArrayList<exam> exam = new ArrayList<exam>();
		Alist obj=new Alist();
		exam = obj.Getexam(netid);
		System.out.println("EXAM IN POSTRESULT:"+exam);
		request.setAttribute("exam", exam);
		RequestDispatcher rd=request.getRequestDispatcher("viewexamforresult.jsp");
