            ...
            <h4 align="center">NEWS</h4>
                        ...
                        <tr>
                       	<td><%=ann.get(i).getNetid()%></td>
                       		<td><%=ann.get(i).getJobs()%></td>
                       		<td><%=ann.get(i).getLocation()%></td>
                       		<td><%=ann.get(i).getLinkjob()%></td>
                        ...
                        //  System.out.println("NAME IN JSP:"+id);
                     		...
                     		if(id.equals(ann.get(i).getNetid()))
                       		{%>
                       			<td><a href='editjob?x=<%= ann.get(i).getJobs_id() %>'>Edit</a></td>
                       			<td><a href='deletejob?x=<%= ann.get(i).getJobs_id() %>'>Delete</a></td>
                       		<%}%>
                        </tr>
