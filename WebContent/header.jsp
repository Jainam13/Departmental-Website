  ...
  <div class="row">		
                <span style="float:right;">
                 <strong >Welcome,<%=session.getAttribute("name").toString() %></strong> &nbsp;
                  <a href="Facultylogin.jsp"><span class="label label-primary btn-lg">Home</span></a>
...
<nav>
<a href="coursedetails">View all courses</a>
<a href="createnewcourse.jsp?x=<%=session.getAttribute("id") %>">Create new course</a>
...
<nav>
<a href="selectedcourse?x=<%=session.getAttribute("id") %>">Post Office hours</a>
<a href="viewpost?x=<%=session.getAttribute("id") %>">View Posts</a>
